...
{
    public class CRangeValidator : RangeValidator
    {
        #region Properties
        ...
        {
            get { return ViewState.Get<string>("ErrorMessageResourceKey", "RangeValidatorErrorMessage"); }
        ...
        protected override void OnPreRender(EventArgs e)
        {
            ...
            {
                Utilities.AddPopoverAttributes(this.ID, this.Attributes, PopoverDiractions.Left, PopoverTriggers.Hover, this.ErrorMessageResourceKey, this.MinimumValue, this.MaximumValue);
