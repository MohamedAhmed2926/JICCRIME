...
namespace JIC.Fault.Repositories.Repositories
{
    public class PersonRepository : EntityRepositoryBase<Configurations_Persons>, IPersonRepository
    {
        public bool AddPerson(vw_PersonData personData, out long personID)
        {
            ...
            {
                Address = (personData.address != null ? personData.address.address : null),
        ...
        {
            return DataContext.Security_Users.Where(user => user.PersonsId == ID).Count() == 0
        ...
        public PersonStatus EditPerson(vw_PersonData personData)
        {
            ...
            else
            {
                ...
                Person.Address = personData.address.address;
